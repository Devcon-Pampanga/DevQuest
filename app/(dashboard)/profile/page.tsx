...
export default function ProfilePage() {
  ...
  const badges = useMemo((): BadgeDef[] => {
    ...
    const list: BadgeDef[] = [
      ...
      { id: 14, name: "XP Milestone: 500",       description: "Reach 500 total XP",                             earned: (userData.xp ?? 0) >= 500,image: "/medals/xp-500.png" },
      { id: 15, name: "XP Milestone: 1000",      description: "Reach 1000 total XP",                            earned: (userData.xp ?? 0) >= 1000,image: "/medals/xp-1000.png" },
    ];
    return list;
