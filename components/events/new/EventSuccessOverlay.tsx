...
export function EventSuccessOverlay({ eventName }: { eventName: string }) {
  return (
    <div
    ...
    >
      ...
      <h2 className="font-heading text-3xl text-text-primary mb-3 tracking-wide">Event live.</h2>
      <p className="text-text-secondary text-sm text-center max-w-xs leading-relaxed">
        Volunteers can now register for {eventName}.
      </p>
