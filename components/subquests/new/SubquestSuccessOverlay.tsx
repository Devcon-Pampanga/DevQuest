...
import type { SubquestAssignmentType, SubquestDifficulty } from "@/types/subquest";
import { DIFFICULTY_META } from "@/types/subquest";

export function SubquestSuccessOverlay({
  difficulty,
  successInfo,
}: {
  difficulty: SubquestDifficulty;
  successInfo: { count: number; type: SubquestAssignmentType };
}) {
